...
public class Case implements java.io.Serializable{
	...
	private int abscisse;		//deux int indiquant l'abscisse et l'ordonn�e de la case 
	private int ordonnee;
	private String contenu;		//un string qui indiquera ce que contiendra la case (joueur , caisse , mur....)
	private int cible;
	
	//Constructeur par d�faut de la classe Case :
	public Case(){
		abscisse =0;
		ordonnee = 0;
		contenu = " ";
	...
	//M�thode permettant d'afficher le contenu de la case :
	...
	//Getter de l'ordonn�e de la case :
	
	public int getOrdonnee() {
		return ordonnee;
	}
	
	//Setter de l'ordonn�e de la case :
